...
token = '8If5PUueJehCYhXXIfcvDkDkseleeR4Dx85Klbod2Lv'  # YCLiu
token_SJX = 'ukeljeZgqnHjnKCZWDOtP9OwY4lHeBWo4QuE59H7fEB' # SJX05

# The API url of LINE Notify
api_url = 'https://notify-api.line.me/api/notify'

# Send the formatted datetime as a message that will be sent
message = "Sending test message for FTA flight update!\n"\
            + "http://202.158.223.244/OPS_STUDENT_REPORTS/rdLogon.aspx" # <- Feel free to replace this with any kind of message that you want. For instance, 'Are you happy today ? Take care.'
